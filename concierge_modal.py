...
image = (
    ...
    # diff-gaussian-rasterization — clone with submodules (glm), patch CUDA 12.1 headers, then build
    .run_commands(
...
def _generate_concierge_zip(image_path, video_path, cfg, lam, flametracking, motion_name=None):
    ...
    try:
        ...
        # (gen_vertex_order_with_blender). DO NOT overwrite with sequential indices.
